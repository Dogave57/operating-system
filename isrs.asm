...
mov dword [esp+28], ebx;eip
mov dword ebx, [eax+20]
mov dword [esp], ebx;ebp
mov dword ebx, [eax+24]
mov dword [esp+4], ebx;eax
mov dword ebx, [eax+28]
mov dword [esp+8], ebx;ebx
mov dword ebx, [eax+32]
mov dword [esp+12], ebx;ecx
mov dword ebx, [eax+36]
mov dword [esp+16], ebx;edx
mov dword ebx, [eax+40]
mov dword [esp+20], ebx;esi
mov dword ebx, [eax+44]
mov dword [esp+24], ebx;edi
mov dword ebp, [esp]
mov dword eax, [esp+4]
mov dword ebx, [esp+8]
